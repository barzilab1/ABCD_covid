...
covidp = covidp[,grep("src|timepoint|^fam_(a|w|dia|ht|exp([1-7]|_rac))|increased_conflict|^child_(sep|tested|worried)|(to_|.?)school_(at|close_cv|cv)|work_ability|interview_age|child_enjoy|child_fear|p_enj", colnames(covidp), value = T)]
